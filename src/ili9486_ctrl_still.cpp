...
// GPIOをレジスタ制御するために領域確保
    ...
    *gpset0 =  (1<<LCD_RESX);   // RESETX=1
    ...
    //char filename[]="320x480_1.bmp";
    char filename[]="480x320_1.bmp";
    //char filename[]="bmp/image_2693.bmp";
    Load_bmp(srcp,filename,&in_xsize,&in_ysize);
    fprintf(stdout,"in_xsize=%d, in_ysize=%d\n",in_xsize,in_ysize);
    ...
    dstp = init_dstp;
    // RGB888 -> RGB565
    //chg_888_to_565(init_srcp, dstp, ((320-270)/2), 0, 270, 480, vram_hsize);
